...
export const Publication = Backbone.Model.extend({
    ...
    parse(d) {
        ...
        return {
            ...
            doi_url: DX_DOI_URL + attr['pubmed-id'],
...
export const PublicationsCollection = Backbone.Collection.extend({
    model: Publication,
...
export const PublicationStudies = Backbone.Collection.extend({
    url() {
