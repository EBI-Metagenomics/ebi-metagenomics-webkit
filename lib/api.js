...
export const Run = Backbone.Model.extend({
    ...
    parse(d) {
        ...
        return {
            ...
            analysis_url: util.subfolder + '/run/' + attr.accession,
...
export const Sample = Backbone.Model.extend({
    ...
    parse(d) {
        ...
        return {
            ...
            lineage: util.formatLineage(biome.data.id || NO_DATA_MSG),
            metadatas: metadatas,
            runs: d.included,
            last_update: util.formatDate(attr['last-update']),
...
export const Analysis = RunPipelineObject.extend({
    ...
    parse(d) {
        ...
        const attr = data.attributes;
        let sampleID;
        if (Object.prototype.hasOwnProperty(d.relationships, 'sample')) {
            sampleID = d.relationships.sample.data.id;
        } else {
            sampleID = null;
        }
        let runID;
        if (Object.prototype.hasOwnProperty(d.relationships, 'run')) {
        ...
        return {
            ...
            sample_url: util.subfolder + '/samples/' + sampleID,
            run_accession: runID,
            run_url: util.subfolder + '/run/' + runID,
            analysis_accession: d['id'],
